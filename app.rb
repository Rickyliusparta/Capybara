...
# The selenium driver should work out of the box trusting the marionnette driver has been successfully installed
session = Capybara::Session.new(:firefox)

session.visit('http://toolsqa.com/automation-practice-form/')

# the simple fill in option search for both ID and Name options
